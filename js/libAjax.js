var xhr = {
  ...
  'checkParams':function(params) {
    ...
    if(typeof(params.startCallBack) != 'function') { params.startCallBack = xhr.ef; }
  ...
  'checkQueue':function() {
    ...
    if(typeof(reqData.params.startCallBack) == 'function') { reqData.params.startCallBack(reqData.params.extraParams); }
    xhr.execute(reqData);
  },
